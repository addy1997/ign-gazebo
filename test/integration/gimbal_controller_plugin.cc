...
TEST_F(GimbalControllerTestFixture, JointPositionCommand)
{
  ...
  transport::Node node;
  auto pub = node.Advertise<msgs::StringMsg>("/model/gimbal/gimbal_pitch_status");
  auto pub = node.Advertise<msgs::StringMsg>("/model/gimbal/gimbal_yaw_status");
  auto pub = node.Advertise<msgs::StringMsg>("/model/gimbal/gimbal_roll_status");
